...
const Navbar = () => {
  ...
  if (location.pathname.startsWith('/dashboard/admin') || location.pathname === '/admin-login') {
      return null;
  }
        ...
        <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
                ...
                {role ? (
                    ...
                    <>
                        <Link to="/signup?role=parent" className="px-3 py-2 rounded-lg transition-all duration-300 border border-transparent hover:bg-indigo-50 dark:hover:bg-slate-800 hover:border-indigo-600 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 text-slate-600 dark:text-slate-300 font-medium">Find Tutors</Link>
                        <Link to="/signup?role=teacher" className="px-3 py-2 rounded-lg transition-all duration-300 border border-transparent hover:bg-indigo-50 dark:hover:bg-slate-800 hover:border-indigo-600 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 text-slate-600 dark:text-slate-300 font-medium">Become a Tutor</Link>
                        <Link to="/about" className="px-3 py-2 rounded-lg transition-all duration-300 border border-transparent hover:bg-indigo-50 dark:hover:bg-slate-800 hover:border-indigo-600 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 text-slate-600 dark:text-slate-300 font-medium">About Us</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-t border-slate-100 dark:border-slate-800 absolute w-full left-0 shadow-xl">
            <div className="px-4 pt-2 pb-6 space-y-2">
                {!role && (
                    <>
                        <Link to="/signup?role=parent" className="block px-3 py-3 text-slate-600 dark:text-slate-300 font-medium hover:bg-indigo-50 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors">Find Tutors</Link>
                        <Link to="/signup?role=teacher" className="block px-3 py-3 text-slate-600 dark:text-slate-300 font-medium hover:bg-indigo-50 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors">Become a Tutor</Link>
                        <Link to="/about" className="block px-3 py-3 text-slate-600 dark:text-slate-300 font-medium hover:bg-indigo-50 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors">About Us</Link>
                    </>
                )}
                {role ? (
                        <>
