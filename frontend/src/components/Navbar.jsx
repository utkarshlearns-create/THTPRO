            ...
            <div className="hidden md:flex items-center space-x-8">
                ...
                {role ? (
                    <div className="flex items-center gap-6 ml-auto">
                        <Link to={role === 'TEACHER' ? '/dashboard/tutor?tab=wallet' : '/dashboard/parent?tab=wallet'} className="flex items-center gap-2 px-4 py-2 bg-slate-100/80 rounded-full text-indigo-900 font-bold text-sm border border-slate-200/60 shadow-sm hover:bg-slate-200 transition-colors">
                             <Wallet size={18} className="text-indigo-600" />
                             <span>₹ {walletBalance}</span>
                        </Link>
                        <Link to={role === 'TEACHER' ? '/dashboard/tutor?tab=notifications' : '/dashboard/parent?tab=notifications'} className="relative p-2 text-slate-500 hover:text-indigo-600 transition-all hover:bg-slate-100 rounded-full">
                            <Bell size={24} />
                    ...
                    <>
                        <Link to="/signup?role=parent" className="px-3 py-2 rounded-lg transition-all duration-300 border border-transparent hover:bg-indigo-50 hover:border-indigo-600 hover:text-indigo-600 text-slate-600 font-medium">Find Tutors</Link>
                        ...
                        <Link to="/about" className="px-3 py-2 rounded-lg transition-all duration-300 border border-transparent hover:bg-indigo-50 hover:border-indigo-600 hover:text-indigo-600 text-slate-600 font-medium">About Us</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-slate-100 absolute w-full left-0 shadow-xl">
            <div className="px-4 pt-2 pb-6 space-y-2">
                {!role && (
                    <>
                        <Link to="/signup?role=parent" className="block px-3 py-3 text-slate-600 font-medium hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-colors">Find Tutors</Link>
                        ...
                        <Link to="/about" className="block px-3 py-3 text-slate-600 font-medium hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-colors">About Us</Link>
                    </>
                )}
                {role ? (
                        <>
