  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen transition-colors duration-300">
            ...
            <div className="text-left">
                ...
                >
                    ...
                    <div className="flex items-center gap-4 text-sm font-semibold text-slate-600 dark:text-slate-400">
                         <span>Or</span>
                         <Link href="/signup?role=teacher" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                            Become a Tutor
                        </Link>
                    </div>
                </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.02]" style={{ backgroundImage: "radial-gradient(#6366f1 1px, transparent 1px)", backgroundSize: "24px 24px" }}></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn className="text-center mb-14">
            <h2 className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 tracking-widest uppercase mb-3">Get Started</h2>
            <p className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">
              Choose Your Role
            </p>
            <p className="mt-4 text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
              Whether you're a parent, a teacher, or an institution — we have the right tools for you.
            </p>
          </FadeIn>
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <div className="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1588072432836-e10032774350?w=600&h=400&fit=crop&crop=faces" 
            ...
            <motion.div variants={itemVariants}>
              <div className="group bg-white dark:bg-slate-900 rounded-2xl border-2 border-teal-400 dark:border-teal-600 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative">
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1577896851231-70ef18881754?w=600&h=400&fit=crop&crop=faces" 
                    alt="Teacher in front of blackboard" 
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                </div>
                <div className="p-6 text-center">
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">I'm a Teacher</h3>
                  <p className="text-sm font-semibold text-teal-600 dark:text-teal-400 italic mb-2">Grow Your Impact</p>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-5">Reach more students and build your career</p>
                  <Link 
                    href="/signup?role=teacher" 
                    className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white font-bold text-sm rounded-full shadow-lg shadow-teal-200 dark:shadow-none transition-all duration-300 hover:scale-105"
                  >
                    Register as Teacher <ArrowRight className="h-4 w-4" />
                  </Link>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <div className="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-6 text-center">
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">I'm a School/Institute</h3>
                  <p className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 italic mb-2">Post Requirements</p>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-5">Find qualified teachers for your institution</p>
                  <Link 
                    href="/signup?role=parent" 
                    className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 text-white font-bold text-sm rounded-full shadow-lg shadow-indigo-200 dark:shadow-none transition-all duration-300 hover:scale-105"
                  >
                    Register as Institute <ArrowRight className="h-4 w-4" />
                  </Link>
                </div>
              </div>
            </motion.div>
