...
const HRMModule = () => {
    ...
    const getRoleBadge = (role, department) => {
        switch(role) {
            ...
            case 'COUNSELLOR': return <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-bold flex items-center gap-1"><Shield size={12}/> Counsellor</span>;
            case 'TUTOR_ADMIN': return <span className="px-2 py-1 bg-cyan-100 text-cyan-700 rounded-full text-xs font-bold flex items-center gap-1"><Shield size={12}/> Tutor Admin</span>;
