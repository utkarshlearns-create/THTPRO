...
const LandingPage = () => {
  return (
    <div className="bg-white min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32 bg-[url('/hero-main.jpg')] bg-cover bg-no-repeat bg-[center_top] sm:bg-[20%_center] lg:bg-[10%_center] bg-white">
