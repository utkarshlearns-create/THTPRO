...
# Handle ALLOWED_HOSTS safely (strip protocols if user accidentally added them)
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'cloudinary_storage',  # NEW: Cloudinary storage
...
CORS_ALLOWED_ORIGINS = [origin.strip() for origin in os.environ.get('CORS_ALLOWED_ORIGINS', "http://localhost:3000,http://localhost:5173").split(',')]

CSRF_TRUSTED_ORIGINS = [origin.strip() for origin in os.environ.get('CSRF_TRUSTED_ORIGINS', "http://localhost:3000,http://localhost:5173").split(',')]
